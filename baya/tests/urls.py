...
urlpatterns = [
    ...
    url(r'^login/$', LoginView.as_view(template_name='baya/login.html'), name='login'),
    url(r'^lazy_login/$', LoginView.as_view(template_name='baya/login.html'), name='lazy_login'),
